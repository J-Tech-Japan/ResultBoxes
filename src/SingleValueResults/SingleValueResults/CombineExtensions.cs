...
public static class CombineExtensions
{
    ...
    public static ThreeValuesResult<TValue1, TValue2, TValue3> CombineValue<TValue1, TValue2, TValue3>(
...
{
    public static async Task<SingleValueResult<TwoValues<TValue1, TValue2>>> CombineValue<TValue1, TValue2>(
