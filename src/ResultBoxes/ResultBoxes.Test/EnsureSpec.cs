...
public class EnsureSpec
{
    ...
    public void EnsureTest1()
    {
        ...
        var result2 = result.Ensure(x => x switch
        {
    ...
    {
        var result = ResultBox.FromValue(20).Ensure(x => x switch
        {
            > 10 => new InvalidDataException("error1"),
            0 => new DivideByZeroException("error2"),
            _ => ExceptionOrNone.None
    ...
    {
        var result = ResultBox.FromValue(0).Ensure(x => x switch
        {
            > 10 => new InvalidDataException("error1"),
            0 => new DivideByZeroException("error2"),
            _ => ExceptionOrNone.None
    ...
    {
        var result1 = await Task.FromResult(ResultBox.FromValue(1)).Ensure(x => x switch
        {
            > 10 => new InvalidDataException("error1"),
            0 => new DivideByZeroException("error2"),
            _ => ExceptionOrNone.None
    ...
    {
        var result = await Task.FromResult(ResultBox.FromValue(20)).Ensure(x => x switch
        {
            > 10 => new InvalidDataException("error1"),
            0 => new DivideByZeroException("error2"),
            _ => ExceptionOrNone.None
    ...
    {
        var result = await Task.FromResult(ResultBox.FromValue(0)).Ensure(x => x switch
        {
            > 10 => new InvalidDataException("error1"),
            0 => new DivideByZeroException("error2"),
            _ => ExceptionOrNone.None
