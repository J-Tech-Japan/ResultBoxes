    ...
    where TValue1 : notnull where TValue2 : notnull
{
    ...
    public ResultBox<TValue3> Call<TValue3>(Func<TValue1, TValue2, ResultBox<TValue3>> addingFunc) where TValue3 : notnull
        => addingFunc(Value1, Value2);
    public Task<ResultBox<TValue3>> Call<TValue3>(Func<TValue1, TValue2, Task<ResultBox<TValue3>>> addingFunc) where TValue3 : notnull
        => addingFunc(Value1, Value2);
    public Task<TValue3> Call<TValue3>(Func<TValue1, TValue2, Task<TValue3>> addingFunc) where TValue3 : notnull
        => addingFunc(Value1, Value2);
