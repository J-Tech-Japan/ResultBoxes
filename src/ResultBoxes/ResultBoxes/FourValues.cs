    ...
    where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull where TValue4 : notnull
{
    ...
    public ResultBox<TValue5> Call<TValue5>(Func<TValue1, TValue2, TValue3, TValue4, ResultBox<TValue5>> addingFunc) where TValue5 : notnull
        => addingFunc(Value1, Value2, Value3, Value4);
    public Task<ResultBox<TValue5>> Call<TValue5>(Func<TValue1, TValue2, TValue3, TValue4, Task<ResultBox<TValue5>>> addingFunc) where TValue5 : notnull
        => addingFunc(Value1, Value2, Value3, Value4);
}