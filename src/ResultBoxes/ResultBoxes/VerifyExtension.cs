...
public static class VerifyExtension
{
    ...
    public static async Task<ResultBox<TValue>> Verify<TValue>(
        ...
        where TValue : notnull
    {
        return await (await result).Conveyor(
    ...
    #endregion
    #region SingleValueWithNoParameter
    ...
    {
        return result.Conveyor(
            async value => await predicate() switch
            {
                { Exception: { } error } => ResultBox<TValue>.FromException(error),
                _ => result
            });
    ...
    public static ResultBox<TValue> Verify<TValue>(
        ...
        where TValue : notnull
    {
        return result.Conveyor(predicate)
    ...
    #endregion
    #region SingleValueWithResultWithNoParameter
        ...
        where TValue4 : notnull
    {
        return result.Conveyor(
            ...
            {
                { Exception: { } error } => ResultBox<FourValues<TValue1, TValue2, TValue3, TValue4>>.FromException(
                    error),
                _ => result
            });
    }

    public static async Task<ResultBox<FourValues<TValue1, TValue2, TValue3, TValue4>>> Verify<TValue1, TValue2,
        TValue3, TValue4, T>(
    ...
    public static Task<ResultBox<FourValues<TValue1, TValue2, TValue3, TValue4>>> Verify<TValue1, TValue2, TValue3,
        TValue4, T>(
        this Task<ResultBox<FourValues<TValue1, TValue2, TValue3, TValue4>>> result,
        Func<TValue1, TValue2, TValue3, TValue4, ResultBox<ExceptionOrNone>> predicate)
        where TValue1 : notnull
    ...
    public static ResultBox<FiveValues<TValue1, TValue2, TValue3, TValue4, TValue5>> Verify<TValue1, TValue2, TValue3,
        TValue4, TValue5>(
        ...
        where TValue5 : notnull
    {
        return result.Conveyor(
            ...
            {
                { Exception: { } error } => ResultBox<FiveValues<TValue1, TValue2, TValue3, TValue4, TValue5>>
                    .FromException(error),
                _ => result
            });
    }

    public static async Task<ResultBox<FiveValues<TValue1, TValue2, TValue3, TValue4, TValue5>>> Verify<TValue1,
        ...
        where TValue5 : notnull
    {
        return await result.Conveyor(
            async values =>
                await predicate(values.Value1, values.Value2, values.Value3, values.Value4, values.Value5) switch
                {
                    { Exception: { } error } => ResultBox<FiveValues<TValue1, TValue2, TValue3, TValue4, TValue5>>
                        .FromException(error),
                    _ => result
    ...
    public static Task<ResultBox<FiveValues<TValue1, TValue2, TValue3, TValue4, TValue5>>> Verify<TValue1, TValue2,
        TValue3, TValue4, TValue5>(
        this Task<ResultBox<FiveValues<TValue1, TValue2, TValue3, TValue4, TValue5>>> result,
        Func<TValue1, TValue2, TValue3, TValue4, TValue5, ResultBox<ExceptionOrNone>> predicate)
        where TValue1 : notnull
        where TValue2 : notnull
