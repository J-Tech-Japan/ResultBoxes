    ...
    where TValue1 : notnull where TValue2 : notnull where TValue3 : notnull
{
    ...
    public ResultBox<TValue4> Call<TValue4>(Func<TValue1, TValue2, TValue3, ResultBox<TValue4>> addingFunc) where TValue4 : notnull
        => addingFunc(Value1, Value2, Value3);
    public Task<ResultBox<TValue4>> Call<TValue4>(Func<TValue1, TValue2, TValue3, Task<ResultBox<TValue4>>> addingFunc) where TValue4 : notnull
        => addingFunc(Value1, Value2, Value3);
}